...
Python program to download torrent files that need seeding the most: go to [Anna's archive](https://annas-archive.gl/torrents) for information.

Now linked on Anna's Archive: [Generate torrent list](https://annas-archive.gl/torrents#generate_torrent_list).
